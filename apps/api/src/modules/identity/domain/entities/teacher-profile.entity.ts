...
export interface TeacherProfileProps extends BaseProfileProps {
...
export class TeacherProfileEntity {
  constructor(private readonly props: TeacherProfileProps) {}
  ...
  get designation(): string | null | undefined { return this.props.designation; }
  get specialization(): string | null | undefined { return this.props.specialization; }
  get subjects(): string[] | undefined { return this.props.subjects; }
