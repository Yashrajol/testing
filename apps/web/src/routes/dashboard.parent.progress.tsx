...
import { 
  ...
  AlertCircle, ChevronRight, FileText, BarChart
} from "lucide-react";
...
const subjectsData = [
  ...
  { 
    ...
    score: 74, 
    trend: "Consistent",
    teacher: "Mr. Kishore Kumar", 
    lastTest: "15/20 (Civics Short Test)", 
    improvement: "Enhance detailed analysis in historical mapping and chronological timelines." 
  },
  { 
    subject: "Hindi", 
    score: 88, 
    trend: "+3% since midterm",
    teacher: "Mrs. Meena Pant", 
    lastTest: "19/20 (Hindi Literature)", 
    improvement: "Excellent comprehension. Practice grammatical structures in prose writing." 
  }
];
...
function ChildProgressPage() {
  ...
  return (
    ...
    >
      <PageHeader title="Child Progress" subtitle="Detailed performance breakdown and academic trajectories." />

      {/* Overview Cards Row */}
      <motion.div variants={itemVariants} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="glass p-5 rounded-2xl border border-slate-100 bg-white">
          ...
          <div className="mt-3 font-display text-3xl font-bold text-text-heading">81.4%</div>
        ...
        <div className="glass p-5 rounded-2xl border border-slate-100 bg-white">
          ...
          <div className="mt-3 font-display text-3xl font-bold text-text-heading">4 Complete</div>
              ...
              <div>
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-text-muted leading-relaxed mt-1">{sub.improvement}</p>
                  </div>
                </div>
              </div>
            </GlassCard>
