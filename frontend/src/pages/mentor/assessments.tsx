...
export default function MentorAssessmentsPage() {
  ...
  const myStudents = useMemo(() => {
    const list = Array.isArray(apiAssessments) 
      ? apiAssessments 
      : Array.isArray((apiAssessments as any)?.data) 
      ? (apiAssessments as any).data 
      : Array.isArray((apiAssessments as any)?.assessments) 
      ? (apiAssessments as any).assessments 
      : [];
