...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VEDHKRIT — From Potential to Purpose" },
      { name: "description", content: "Integrated learner development platform combining assessment, mentoring, career guidance, skill development, and AI-powered insights." },
      { property: "og:title", content: "VEDHKRIT — From Potential to Purpose" },
      { property: "og:description", content: "Integrated learner development platform combining assessment, mentoring, career guidance, skill development, and AI-powered insights." },
    ...
    links: [
      ...
      { rel: "preload", as: "style", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@500;600;700;800;900&display=swap" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@500;600;700;800;900&display=swap" },
    ],
  }),
